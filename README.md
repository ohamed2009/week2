...
All six services are deployed on Render (free tier) and backed by a MongoDB
Atlas cluster. Each exposes `GET /health`.

| Service              | Deployed URL                                      |
| -------------------- | ------------------------------------------------- |
| user-service         | https://user-service-9z3r.onrender.com            |
| catalog-service      | https://catalog-service-d3qb.onrender.com         |
| order-service        | https://order-service-v997.onrender.com           |
| payment-service      | https://payment-service-cr5h.onrender.com         |
| inventory-service    | https://inventory-service-o6dg.onrender.com       |
| notification-service | https://notification-service-bfrp.onrender.com    |

> Free-tier services sleep after ~15 min of inactivity and take ~30–50s to wake
> up. Before a live demo, open each `/health` URL first to warm them, then place
> an order. Deployment steps are documented in [docs/DEPLOY.md](docs/DEPLOY.md).
